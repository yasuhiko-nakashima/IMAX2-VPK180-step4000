...
# Set xvlog options
xvlog_opts="--incr --relax  -L uvm -L cpm5_v1_0_11 -L cpm4_v1_0_11 -L noc_nps_v1_0_0 -L emb_mem_gen_v1_0_6 -L noc_nsu_v1_0_0 -L axi_vip_v1_1_13 -L smartconnect_v1_0 -L versal_cips_ps_vip_v1_0_5 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_27 -L axi_vip_v1_1_13 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L xlconstant_v1_1_7 -L versal_cips_ps_vip_v1_0_5 -L xil_defaultlib -L cpm4_v1_0_11 -L cpm5_v1_0_11 -L noc_nsu_v1_0_0 -L emb_mem_gen_v1_0_6 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_70da.protoinst" -protoinst "protoinst_files/bd_8be5.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/xlnoc.protoinst" -log simulate.log
}
